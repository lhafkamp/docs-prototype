			...
			<footer>
				<div>
					...
					<ul>
						...
						<li>Passenger: <a href="https://github.com/phusion/passenger"><img src={`${process.env.PUBLIC_URL}/img/footer/github.svg`} src="/img/footer/github.svg" alt="Passenger Github"/></a></li>
